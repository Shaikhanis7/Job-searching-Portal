...
import { Briefcase, ClipboardList, Edit2, Trash2, PlusCircle, Mail, Phone, MapPin } from 'lucide-react';

const UserDashboard = () => {
    const [user, setUser] = useState({
        name: 'Thilagavathi K',
        email: '727822tucs247@skct.edu.in',
        phone: '+1 234 567 8901',
        address: '1234 Elm Street, Cityville, CA 90001',
        profilePicture: 'https://avatars.githubusercontent.com/u/125294900?v=4',
    });
        ...
        <div className="p-6">
            <div className="flex items-center mb-6">
                ...
                <div className="ml-4">
                    ...
                    <p className="text-primary flex items-center"><Mail className="mr-2" size={16} />{user.email}</p>
                    <p className="text-primary flex items-center"><Phone className="mr-2" size={16} />{user.phone}</p>
                    <p className="text-primary flex items-center"><MapPin className="mr-2" size={16} />{user.address}</p>
            ...
            <div className="mb-6">
                <h3 className="text-xl font-bold text-primary flex items-center gap-2">
                    ...
                    <button onClick={handleAddApplication} className="ml-auto text-green-500 hover:underline flex items-center gap-1">
